    ...
    <div className="min-h-screen w-full bg-orange-600 bg-[radial-gradient(circle_at_center,#ea580c_0%,#c2410c_100%)] flex flex-col items-center justify-center p-4 font-sans text-zinc-900 overflow-hidden relative">
      ...
      <div className="max-w-md w-full bg-white rounded-[45px] shadow-[0_20px_50px_rgba(0,0,0,0.2)] p-8 space-y-6 animate-in zoom-in duration-500 overflow-y-auto max-h-[95vh] scrollbar-none border border-white/20 relative z-10">
        ...
        {telaAuth === 'Login' ? (
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-black text-zinc-900 tracking-tight text-center leading-none">Criar Cadastro</h2>
            ...
            <div className="space-y-2.5">
              <div className="relative group">
                ...
                <input 
                  ...
                  className="w-full p-3 pl-11 bg-zinc-50 border border-zinc-100 rounded-2xl outline-none focus:bg-white focus:ring-2 ring-orange-500 shadow-inner font-medium text-sm transition-all" 
                  ...
                  <>
                    <div className="relative col-span-2 group">
                      ...
                      <input 
                        ...
                        className="w-full p-3 pl-11 bg-orange-50 border border-orange-100 rounded-2xl outline-none focus:bg-white focus:ring-2 ring-orange-500 shadow-inner font-medium text-sm transition-all" 
                        value={nomeLoja}
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <div className="relative group">
                   <input 
                    ...
                    className="w-full p-3 bg-zinc-50 border border-zinc-100 rounded-2xl outline-none focus:bg-white focus:ring-2 ring-orange-500 shadow-inner font-medium text-sm text-center transition-all" 
            ...
            <button 
              ...
              className="w-full bg-zinc-800 text-white p-4 rounded-2xl font-black text-base shadow-lg hover:scale-[1.02] active:scale-[0.98] transition-all mt-2 flex items-center justify-center gap-2"
            >
              Finalizar Cadastro
            </button>
