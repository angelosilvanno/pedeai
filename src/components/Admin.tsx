    ...
    <div className="space-y-8 animate-in slide-in-from-top duration-700 pb-32">
      ...
      <div className="flex items-center gap-6 py-6 border-b border-zinc-100 bg-white -mx-5 px-5 mb-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-green-600 font-bold text-[10px] mt-1 uppercase tracking-widest flex items-center gap-1 leading-none">
      ...
      {abaAdmin === 'Dash' ? (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 gap-5 px-1">
            ...
            {/* CARD FATURAMENTO */}
            <div className="bg-white p-10 rounded-[50px] shadow-sm border border-zinc-100 text-center space-y-4">
              <div className="mx-auto h-16 w-16 bg-green-50 rounded-3xl flex items-center justify-center text-green-600">
                <DollarSign size={32} />
              </div>
              <div>
                <p className="text-xs font-black text-zinc-400 uppercase tracking-widest leading-none">Faturamento Total</p>
                <p className="text-4xl font-black text-green-600 tracking-tighter mt-3 italic leading-none">
            ...
            {/* CARD PARCEIROS */}
            <div className="bg-white p-10 rounded-[50px] shadow-sm border border-zinc-100 text-center space-y-4">
              <div className="mx-auto h-16 w-16 bg-orange-50 rounded-3xl flex items-center justify-center text-orange-600">
                <Users size={32} />
              </div>
              <div>
                <p className="text-xs font-black text-zinc-400 uppercase tracking-widest leading-none">Total de Parceiros</p>
                <p className="text-4xl font-black text-orange-600 tracking-tighter mt-3 leading-none">
                  {todasAsLojas.length}
                </p>
              </div>
            </div>
